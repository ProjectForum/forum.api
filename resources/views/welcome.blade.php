...
<head>
    ...
    <link href="{{ asset('build/static/css/main.ca2e4424.chunk.css') }}" rel="stylesheet">
</head>
<body>
...
<script src="{{ asset('build/static/js/2.4b44abd2.chunk.js') }}"></script>
<script src="{{ asset('build/static/js/main.43ece32a.chunk.js') }}"></script>
</body>
</html>
